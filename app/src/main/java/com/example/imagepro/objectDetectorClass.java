      ...
      //  float[][][]result=new float[1][10][4];
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                /*
                Before watching this video please watch the previous video of interfacing TensorFlow Lite model
                with android app.

                In this video, we will add "combine letters" function to our sign language recognition app.
